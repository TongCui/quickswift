...
//        XCTAssertEqual(self.intArray.toS, "[1,2,3]" )
//        XCTAssertEqual(stringArray.toS, "[\"1\",\"2\",\"3\"]" )
//        XCTAssertEqual(intKeyDictionary.toS, nil )
//        XCTAssertEqual(stringKeyDictionary.toS, "{\"1\":\"100\",\"2\":\"200\"}" )
//
...
//        XCTAssertEqual(nested.toS, "{\"list\":[{\"1\":\"100\"},{\"2\":\"200\"}]}")
//    }
}
